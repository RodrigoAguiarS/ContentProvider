...
class NotesAdapter(private val listener: NoteClikedListener): RecyclerView.Adapter<NotesViewHolder>(){
    ...
    override fun onBindViewHolder(holder: NotesViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener { listener.noteClikedItem(mCursor as Cursor) }
    }
...
class NotesViewHolder(itemView: View): RecyclerView.ViewHolder(itemView){
    ...
    val noteButtonRemove = itemView.findViewById(R.id.note_button_renove) as Button
