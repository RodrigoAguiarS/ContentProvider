...
import com.rodrigo.contentprovider.database.NotesDatabaseHelper
import com.rodrigo.contentprovider.database.NotesDatabaseHelper.Companion.DESCRIPTION_NOTES
import com.rodrigo.contentprovider.database.NotesDatabaseHelper.Companion.TITLE_NOTES
import com.rodrigo.contentprovider.database.NotesProvider.Companion.URI_NOTES
...
class NotesDetailFragment : DialogFragment(), DialogInterface.OnClickListener {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        noteEdtDescription = view.findViewById(R.id.note_edt_description) as EditText
        ...
        if (arguments != null && arguments?.getLong(EXTRA_ID) != 0L){
            ...
            if (cursor?.moveToNext() as Boolean){
                ...
                noteEdtDescription.setText(cursor.getString(cursor.getColumnIndex(NotesDatabaseHelper.DESCRIPTION_NOTES)))
            }
            cursor.close()
        }
